...
> There's a chance that the folder icon on your bottom dock isnt rendering. The fix for this issue, and other bugs encounter later in the process, are shown under the "Fix Common Bugs" part.
